...
<body>
	...
	<div class="modal fade" id="report" tabindex="-1" role="dialog" aria-labelledby="reportTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title" id="reportTitle" style="margin-top: -12px; margin-bottom: -12px;">
						<b>이 핀 신고하기</b>
					</h3>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
				...
				<div class="modal-body">
					<form action="sendReport">
						...
						<div class="form-group">
							...
							<br /> <label class="radio-inline" style="margin-bottom: -1px;">
								<input type="radio" name="inlineRadioOptions" id="inlineRadio1"
								value="option1">노골적인 성적 콘텐츠
							</label>
						</div>
						<hr />
						<div class="form-group">
						...
						<div class="form-group">
							...
							<br /> <label class="radio-inline" style="margin-bottom: -1px;">
								<input type="radio" name="inlineRadioOptions" id="inlineRadio1"
								value="option1">보호 그룹에 대한 공격
							</label>
						</div>
						<hr />
						<div class="form-group">
							<h5 style="margin-bottom: -30px;">
								<label for="exampleSelectGender"><b>모욕적인 내용 또는 사생활
										침해</b></label>
							</h5>
							<br /> <label class="radio-inline" style="margin-bottom: -1px;">
								<input type="radio" name="inlineRadioOptions" id="inlineRadio1"
								value="option1">위협, 협박, 인신공격
							</label>
						</div>
						<hr />
						<div class="form-group">
							...
							<br /> <label class="radio-inline" style="margin-bottom: -1px;">
								<input type="radio" name="inlineRadioOptions" id="inlineRadio1"
								value="option1">폭력적인 이미지 또는 폭력 조장
							</label>
						</div>
						<hr />
						<div class="form-group">
						...
						<div class="form-group"
							...
							<button type="button" id="submit-form" class="btn btn-primary"
								data-toggle="modal" href="#stack2">신고</button>
						</div>
					</form>

				</div>
				<div class="modal-footer"
					style="margin-top: -29px; margin-bottom: -21px;"></div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content" style="text-align: center; height: 70%;">
				...
				<div class="modal-body">
					<form action="">
						...
						<br />
						<br /> <img src="resources/images/police.gif" alt="" />
						<div>
							<div>
	...
	<div class="masonry" style="margin: 0 0.1em; margin-top: 30px;">
		...
		<c:forEach var="c" items="${img }">
			<div class="item">
				<a href="/bigPic/detail.do?no=${c.imgno }"> <img
					src="${c.filedir }" name="img"> <input type="hidden"
					name="imgno" value="${c.filedir }" />
				</a>
				...
				<div class="pin">
					...
					<div class="more" style="width: 15%;">
						<input type="submit" value="Save" id="exampleInputSave" style=""
							onclick="window.open('down.do?no=${c.imgno}','down.do?no=${c.imgno }','width=430,height=500,location=no,status=no,scrollbars=yes');" />
					</div>
					<div class="imore">
						<div class="dropdown">
