...
<link rel="stylesheet" href="../../resources/css/bigbit_css/header.css">
	...
	<span class="desktop"> 
		<header>
			...
			<nav>
				...
				<a href="#" style="float:right; margin-right:35px;">Login</a>
			</nav>
		</header>
	</span>
...
<script src="../../resources/js/bigbit_js/header.js"></script>
</body>
</html>